    ...
    <section className="about-section bg-gray-300 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mt-16 text-center">
          <div className="inline-flex items-center px-6 py-3 bg-white dark:bg-[#74377a]/10 rounded-full shadow-sm border border-[#74377a]/20 dark:border-[#74377a]/40">
            <svg className="w-5 h-5 mr-2 text-[#74377a]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M13 10V3L4 14h7v7l9-11h-7z"></path>
            </svg>
            <span className="font-medium text-gray-700">Over 250,000 students trust our platform</span>
          </div>
        </div>
      </div>
    </section>
